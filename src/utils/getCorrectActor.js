...
const getCorrectActor = async () => {
    ...
    if (await correctActor === undefined && await correctActor.known_for_department !== "Acting" && await correctActor.known_for[0].original_language !== "en" && await correctActor.gender === 0) {
